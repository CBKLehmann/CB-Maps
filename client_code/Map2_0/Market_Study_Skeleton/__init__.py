...
def market_study_skeleton_en(market_study_data):
  return {
    'number_of_pages': 0,
    'settings': {
        ...
        'summary': {
            ...
            'cell': {
                ...
                'occupancy_rate_2030_s1': {
                    ...
                    'y': 151,
                    'w': 23,
                    'txt': '{:,}%'.format(market_study_data['occupancy_lk_30_v1'] if market_study_data['occupancy_lk_30_v1'] < 100 else 100),
                    'align': 'right'
                },
                ...
                'occupancy_rate_2030_s2': {
                    ...
                    'y': 151,
                    'w': 23,
                    'txt': '{:,}%'.format(market_study_data['occupancy_lk_30_v2'] if market_study_data['occupancy_lk_30_v2'] < 100 else 100),
                    'align': 'right'
                },
                ...
                'occupancy_rate_2035_s1': {
                    ...
                    'y': 151,
                    'w': 23,
                    'txt': '{:,}%'.format(market_study_data['occupancy_lk_35_v1'] if market_study_data['occupancy_lk_35_v1'] < 100 else 100),
                    'align': 'right'
                },
                ...
                'occupancy_rate_2035_s2': {
                    ...
                    'y': 151,
                    'w': 23,
                    'txt': '{:,}%'.format(market_study_data['occupancy_lk_35_v2'] if market_study_data['occupancy_lk_35_v2'] < 100 else 100),
                    'align': 'right'
                },
...
def market_study_skeleton_de(market_study_data):
  return {
    'number_of_pages': 0,
    'settings': {
        'fonts': ['segoeui', 'seguisb', 'segoeuisl', 'calibri']
        ...
        'cover': {
                ...
                'text': {
                    ...
                    'ms_text_4': {
                        ...
                        'x': 55,
                        'y': 240,
                        'txt': 'ist ein webbasierter Dienst'
                    },
                    'ms_text_5': {
                        'color': [0, 0, 0],
                        'font': 'segoeui',
                        ...
                        'x': 10,
                        'y': 246,
                        'txt': 'von Capital Bay, der Investoren Zugang zu Daten über'
                    },
                    'ms_text_6': {
                        'color': [0, 0, 0],
                        'font': 'segoeui',
                        ...
                        'x': 10,
                        'y': 252,
                        'txt': 'den aktuellen deutschen Pflegemarkt einschließlich'
                    },
                    'ms_text_7': {
                        'color': [0, 0, 0],
                        'font': 'segoeui',
                        ...
                        'x': 10,
                        'y': 258,
                        'txt': 'demographischer Prognosen und'
                    },
                    'ms_text_8': {
                        'color': [0, 0, 0],
                        'font': 'segoeui',
                        ...
                        'x': 10,
                        'y': 264,
                        'txt': 'Wettbewerbsanalysen bietet. Dies ermöglicht eine'
                    },
                    'ms_text_9': {
                        'color': [0, 0, 0],
                        'font': 'segoeui',
                        ...
                        'x': 10,
                        'y': 270,
                        'txt': 'gezielte Betrachtung des Marktes mit Hilfe'
                    },
                    'ms_text_10': {
                        'color': [0, 0, 0],
                        'font': 'segoeui',
                    ...
                    'version': {
                        ...
                        'x': 10,
                        'y': 290,
                        'txt': f"Version 2.1.0 - Generiert am {market_study_data['created_date']}"
                    }
                },
                'image': {
                    'logo': {
                ...
                'multi_cell': {
                    ...
                    'population_trend_heading': {
                        ...
                        'w': 90,
                        'h': 4,
                        'txt': 'Bevölkerungsentwicklung der Altersgruppe 65+\nam Standort - bis 2035',
                        'align': 'center'
                    },
                    'beds_heading': {
                        'color': [255, 255, 255],
                        ...
                        'w': 90,
                        'h': 4,
                        'txt': 'Überschuss oder Defizit an Betten\nam Standort - bis 2035',
                        'align': 'center'
                    },
                }
            },
