            ...
            # Do if Elements are under 3000
              ...
              for ele in geojson:
                ...
                # Check if Category is PflegeDB
                  ...
                  marker_details = f"<b>Träger ID: </b> {ele['traeger_id']}"
                  marker_details += "<br>"
                  marker_details += f"<b>IK_Nummer: </b> {ele['ik_nummer']}"
                  marker_details += "<br>"
                  marker_details += "<br>"
                  marker_details += f"<b>Sektor: </b> {ele['sektor']}"
                  marker_details += "<br>"
                  marker_details += f"<b>Art: </b> {ele['art']}"
                  marker_details += "<br>"
                  marker_details += f"<b>Spezialisierung: </b> {ele['spezialisierung']}"
                  marker_details += "<br>"
                  marker_details += f"<b>Status: </b> {ele['status']}"
                  marker_details += "<br>"
                  marker_details += f"<b>Baujahr: </b> {ele['baujahr']}"
                  marker_details += "<br>"
                  marker_details += f"<b>Modernisierungsjahr: </b> {ele['modernisierung']}"
                  marker_details += "<br>"
                  marker_details += "<br>"
                  marker_details += f"<b>Name: </b> {ele['name']}"
                  marker_details += "<br>"
                  marker_details += "<br>"
                  marker_details += f"<b>Betreiber: </b> {ele['betreiber']}"
                  marker_details += "<br>"
                  marker_details += f"<b>Tochterfirma 1: </b> {ele['tochterfirma1']}"
                  marker_details += "<br>"
                  marker_details += f"<b>Tochterfirma 2: </b> {ele['tochterfirma2']}"
                  marker_details += "<br>"
                  marker_details += "<br>"
                  marker_details += f"<b>Straße: </b> {ele['strasse']}"
                  marker_details += "<br>"
                  marker_details += f"<b>Postleitzahl: </b> {ele['plz']}"
                  marker_details += "<br>"
                  marker_details += f"<b>Ort: </b> {ele['ort']}"
                  marker_details += "<br>"
                  marker_details += f"<b>Bundesland: </b> {ele['bundesland']}"
                  marker_details += "<br>"
                  marker_details += "<br>"
                  marker_details += f"<b>Telefon: </b> {ele['telefon']}"
                  marker_details += "<br>"
                  marker_details += f"<b>Fax: </b> {ele['fax']}"
                  marker_details += "<br>"
                  marker_details += f"<b>E-Mail: </b> {ele['email']}"
                  marker_details += "<br>"
                  marker_details += f"<b>Webseite: </b> {ele['webseite']}"
                  marker_details += "<br>"
                  marker_details += f"<b>Domain: </b> {ele['domain']}"
                  marker_details += "<br>"
                  marker_details += "<br>"
                  marker_details += f"<b>MDK Datum: </b> {ele['mdk_datum']}"
                  marker_details += "<br>"
                  marker_details += f"<b>Pflege und medizinische Versorgung: </b> {ele['pfl_u_med_vers']}"
                  marker_details += "<br>"
                  marker_details += f"<b>Umgang mit demenzkranken Bewohnern: </b> {ele['umg_mit_dem_bew']}"
                  marker_details += "<br>"
                  marker_details += f"<b>Soziale Betreuung und Alltagsgestaltung: </b> {ele['soz_betrualltag']}"
                  marker_details += "<br>"
                  marker_details += f"<b>Wohnen, Verpflegung, Hauswirtschaft und Hygiene: </b> {ele['wohn_verpfl_hausw_hyg']}"
                  marker_details += "<br>"
                  marker_details += f"<b>Befragung der Bewohner: </b> {ele['befr_bew']}"
                  marker_details += "<br>"
                  marker_details += f"<b>MDK Note: </b> {ele['mdk_note']}"
                  marker_details += "<br>"
                  marker_details += "<br>"
                  marker_details += f"<b>Anzahl versorgte Patienten: </b> {ele['anz_vers_pat']}"
                  marker_details += "<br>"
                  marker_details += f"<b>Platzzahl vollständige Pflege: </b> {ele['platz_voll_pfl']}"
                  marker_details += "<br>"
                  marker_details += f"<b>Platzzahl Kurzzeitpflege: </b> {ele['platz_kurzpfl']}"
                  marker_details += "<br>"
                  marker_details += f"<b>Platzzahl Nachtpflege: </b> {ele['platz_nachtpfl']}"
                  marker_details += "<br>"
                  marker_details += f"<b>Einzelzimmer: </b> {ele['ez']}"
                  marker_details += "<br>"
                  marker_details += f"<b>Doppelzimmer: </b> {ele['dz']}"
                  marker_details += "<br>"
                  marker_details += "<br>"
                  marker_details += f"<b>Ausbildungsumlage: </b> {ele['ausbildungsumlage']}"
                  marker_details += "<br>"
                  marker_details += f"<b>EEE: </b> {ele['eee']}"
                  marker_details += "<br>"
                  marker_details += f"<b>UuV: </b> {ele['uuv']}"
                  marker_details += "<br>"
                  marker_details += f"<b>Invest: </b> {ele['invest']}"
                  marker_details += "<br>"
                  marker_details += f"<b>PG 1: </b> {ele['pg_1']}"
                  marker_details += "<br>"
                  marker_details += f"<b>PG 2: </b> {ele['pg_2']}"
                  marker_details += "<br>"
                  marker_details += f"<b>PG 3: </b> {ele['pg_3']}"
                  marker_details += "<br>"
                  marker_details += f"<b>PG 4: </b> {ele['pg_4']}"
                  marker_details += "<br>"
                  marker_details += f"<b>PG 5: </b> {ele['pg_5']}"
