...
class Map2_0(Map2_0Template):
  ...
  def Summary_click(self, **event_args):
    ...
    response = '<html><head><title>Summary</title><style>table {border-collapse: collapse} .innerData > td {max-width: 400px; height: 10px} .innerPicture > td {max-width: 400px; height: 10px} th {height: 10px} .left {text-align: left} .right {text-align: right} .center {text-align: center} .donutImage {width: 450px; height: 300px} .barImage {width: 450px; height: 300px} .placeholder {width: 50px} .mapImage {width: 300px; height: 380px; display: block; margin-left: auto; margin-right: auto} .logoImage {position: fixed; top: 0; right: 800;}</style></head><body>'
