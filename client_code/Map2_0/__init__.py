...
class Map2_0(Map2_0Template):
  ...
  def Summary_click(self, **event_args):
    ...
    response += '<table>'
    response += f'<tr style="border-bottom: 1px solid #000;"><th>General Information</th></tr><tr style="height: 20px;" /><tr><th>Zip Code</th><th></th><th></th><th>{zipcode}</th></tr><tr><th>City</th><th></th><th></th><th>{city}</th></tr><tr><th>District</th><th></th><th></th><th>{district}</th></tr><tr><th>Federal State</th><th></th><th></th><th>{federal_state}</th></tr><tr><th>Radius of analysis</th><th></th><th></th><th>Not implemented yet</th></tr><tr style="height: 30px;" />'
    response += f'<tr style="border-bottom: 1px solid #000;"><th>Demographic trend</th></tr><tr style="height: 5px;" /><tr><th>{city}, LK</th><th>2019 Actual</th><th>2030 Forecast</th><th>Change in %</th></tr><tr><td>Population</td><td>Not implemented yet</td></tr><tr><td>Population 65-79</td><td>Not implemented yet</td><td>Not implemented yet</td><td>Not implemented yet</td></tr><tr><td>Population 80+</td><td>Not implemented yet</td><td>Not implemented yet</td><td>Not implemented yet</td></tr><tr><td>Patients receiving full inpatient care</td><td>Not implemented yet</td><td>Not implemented yet</td><td>Not implemented yet</td></tr><tr style="height: 30px;" />'
    response += f'<tr style="border-bottom: 1px solid #000;"><th>Demand</th><td>Radius Not implemented yet</td></tr><tr><td>Number of inpatients</td><td>Not implemented yet</td></tr><tr><td>Number of inpatients forecast 2030</td><td></td><td>Not implemented yet</td></tr><tr style="height: 30px;" />'
    response += f'<tr style="border-bottom: 1px solid #000;"><th>Supply</th><td>Radius Not implemented yet</td></tr><tr><td>Beds</td><td>Not implemented yet</td></tr><tr><td>Nursing homes</td><td>Not implemented yet</td></tr><tr><td>Nursing homes in planning</td><td>Not implemented yet</td></tr><tr><td>Nursing homes under construction</td><td>Not implemented yet</td></tr><tr><td>Beds in planning</td><td>Not implemented yet</td></tr><tr><td>Beds under construction</td><td>Not implemented yet</td></tr><tr><td>Adjusted number of beds (incl. beds in planning and under construction</td><td>Not implemented yet</td></tr><tr><td>Occupancy rate</td><td>Not implemented yet</td></tr><tr><td>Median Invest Cost</td><td>Not implemented yet</td></tr><tr style="height: 5px;" /><tr style="border-bottom: 1px solid #000;"><th>Surplus or deficit 2030 of beds IC</th><th></th><th>Not implemented yet</th></tr><tr style="height: 30px;" />'
    response += f'<tr style="border-bottom: 1px solid #000;"><th>Market shares</th><td>Radius Not implemented yet</td></tr><tr style="height: 15px;" /><tr><td>Number of operators</td><td>Not implemented yet</td></tr><tr><td>Median Number of beds</td><td>Not implemented yet</td></tr><tr><td>Median Year of construction</td><td>Not implemented yet</td></tr><tr><td>% Public operators</td><td>Not implemented yet</td></tr><tr><td>% Non-profit operators</td><td>Not implemented yet</td></tr><tr><td>% Private operators</td><td>Not implemented yet</td></tr>'
    response += '</table>'
    response += '</body></html>'
