...
#######Noch bearbeiten#######
  ...
  def Summary_click(self, **event_args):
    with anvil.server.no_loading_indicator:
      if len(Variables.nursing_homes_entries) > 30 and len(Variables.assisted_living_entries) > 30:
        alert(f'Amount of Nursing Homes and Assisted Living Markers is too big. Please reduce the Distance Layer or individually delete Markers. The maximum Amount of Markers allowed are 30 per Category. The current Marker-Count is {len(Variables.nursing_homes_entries)} for Nursing Homes and {len(Variables.assisted_living_entries)} for Assisted Living', large=True, role='custom_alert')
      elif len(Variables.nursing_homes_entries) > 30:
        alert(f'Amount of Nursing Homes is too big. Please reduce the Distance Layer or individually delete Markers. The maximum Amount of Markers allowed are 30. The current Marker-Count is {len(Variables.nursing_homes_entries)}', large=True, role='custom_alert')
      elif len(Variables.assisted_living_entries) > 30:
        alert(f'Amount of Assisted Living is too big. Please reduce the Distance Layer or individually delete Markers. The maximum Amount of Markers allowed are 30. The current Marker-Count is {len(Variables.assisted_living_entries)}', large=True, role='custom_alert')
      else:
