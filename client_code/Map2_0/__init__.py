...
class Map2_0(Map2_0Template):
  ...
  def Summary_click(self, **event_args):
    ...
    response += f'<tr style="border-bottom: 1px solid #000;"><th class="left">Demographic trend</th></tr><tr style="height: 5px;" /><tr><th class="left">{countie[0]}, LK</th><th></th><th class="right">2019 Actual</th><th class="right">2030 Forecast</th><th class="right">Change in %</th></tr><tr><td class="left">Population</td><td></td><td class="right">{data[0][19]}</td></tr><tr><td class="left">Population 65-74</td><td></td><td class="right">{peopleu75}</td><td class="right">999999</td><td class="center">999%</td></tr><tr><td class="left">Population 75+</td><td></td><td class="right">{peopleo75}</td><td class="right">999999</td><td class="center">999%</td></tr><tr><td class="left">Patients receiving full inpatient care</td><td></td><td class="right">{sum}</td><td class="right">999999</td><td class="center">999%</td></tr><tr style="height: 30px;" />'
