...
class Map2_0(Map2_0Template):
  ...
  def Summary_click(self, **event_args):
    ...
    barValues = [{'topic': 'Number of inpatients', 'value': 470}, {'topic': 'Beds', 'value': 507}, {'topic': 'Number of inpatients forecast 2030', 'value': 473}, {'topic': 'Adjusted number of beds (incl. beds in planning and under construction)', 'value': 507}]
    ...
    response = '<html><head><title>Summary</title><style>table {border-collapse: collapse} .innerData > td {max-width: 400px; height: 10px} .innerPicture > td {max-width: 400px; height: 10px} th {height: 10px} .left {text-align: left} .right {text-align: right} .center {text-align: center} .donutImage {width: 450px; height: 300px} .barImage {width: 450px; height: 300px}</style></head><body>'
    response += '<h1>Executive Summary</h1><br>'
    response += '<table class="innerData">'
    response += f'<tr style="border-bottom: 1px solid #000;"><th class="left">General Information</th></tr><tr style="height: 20px;" /><tr><th class="left">Zip Code</th><th></th><th></th><th class="right">{zipcode}</th></tr><tr><th class="left">City</th><th></th><th></th><th class="right">{city}</th></tr><tr><th class="left">District</th><th></th><th></th><th class="right">{district}</th></tr><tr><th class="left">Federal State</th><th></th><th></th><th class="right">{federal_state}</th></tr><tr><th class="left">Radius of analysis</th><th></th><th></th><th class="right">{time} minutes of {movement}</th></tr><tr style="height: 30px;" />'
    response += f'<tr style="border-bottom: 1px solid #000;"><th class="left">Demographic trend</th></tr><tr style="height: 5px;" /><tr><th class="left">{countie[0]}, LK</th><th class="right">2019 Actual</th><th class="right">2030 Forecast</th><th class="right">Change in %</th></tr><tr><td class="left">Population</td><td class="right">{data[0][19]}</td></tr><tr><td class="left">Population 65-74</td><td class="right">{peopleu75}</td><td class="right">Not implemented yet</td><td class="center">Not implemented yet%</td></tr><tr><td class="left">Population 75+</td><td class="right">{peopleo75}</td><td class="right">Not implemented yet</td><td class="center">Not implemented yet%</td></tr><tr><td class="left">Patients receiving full inpatient care</td><td class="right">{sum}</td><td class="right">Not implemented yet</td><td class="center">Not implemented yet%</td></tr><tr style="height: 30px;" />'
    response += f'<tr style="border-bottom: 1px solid #000;"><th class="left">Demand</th><td class="right">Radius:</td><td class="left"> {time} minutes of {movement}</td></tr><tr><td class="left">Number of inpatients</td><td class="right">{inpatients}</td></tr><tr><td class="left">Number of inpatients forecast 2030</td><td></td><td class="right">Not implemented yet</td></tr><tr style="height: 30px;" />'
    response += f'<tr style="border-bottom: 1px solid #000;"><th class="left">Supply</th><td class="right">Radius:</td><td class="left"> {time} minutes of {movement}</td></tr><tr><td class="left">Beds</td><td class="right">{beds_active}</td></tr><tr><td class="left">Nursing homes</td><td class="right">{nursingHomes_active}</td></tr><tr><td class="left">Nursing homes in planning</td><td class="right">{nursingHomes_planned}</td></tr><tr><td class="left">Nursing homes under construction</td><td class="right">{nursingHomes_construct}</td></tr><tr><td class="left">Beds in planning</td><td class="right">{beds_planned}</td></tr><tr><td class="left">Beds under construction</td><td class="right">{beds_construct}</td></tr><tr><td class="left">Adjusted number of beds (incl. beds</td><td></td></tr><tr><td class="left">in planning and under construction</td><td class="right">{beds_adjusted}</td></tr><tr><td class="left">Occupancy rate</td><td class="right">{occupancy_raw}%</td></tr><tr><td class="left">Median Invest Cost</td><td class="right">{investMedian} €</td></tr><tr style="height: 5px;" /><tr style="border-bottom: 1px solid #000;"><th class="left">Surplus or deficit 2030 of beds IC</th><th></th><th class="right">Not implemented yet</th></tr><tr style="height: 30px;" />'
