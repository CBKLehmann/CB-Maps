...
class Map2_0(Map2_0Template):
  ...
  def Summary_click(self, **event_args):
    ...
    response = '<html><head><title>Summary</title><style>.outerTable {width: 1300px; border-collapse: collapse} .innerData {border-collapse: collapse; padding: 0; margin: 0; width: 100%} .innerData > * {padding: 0; margin: 0} .innerData > td {max-width: 1100px; height: 10px} .innerPicture > td {max-width: 1100px; height: 10px} th {height: 10px} .left {text-align: left} .right {text-align: right} .center {text-align: center} .donutImage {width: 450px; height: 300px} .barImage {width: 450px; height: 300px} .placeholder {width: 50px} .mapImage {width: 300px; height: 380px; display: block; margin-left: auto; margin-right: auto} .logoImage {position: fixed; top: 0; right: 800;}</style></head><body>'
    response += f'<h1>Executive Summary</h1><img class="logoImage" id="logoImage" src="{logoPic.url}"><br>'
    response += '<table class="outerTable"><tr><td>'
    response += '<table class="innerData">'
    response += f'<tr style="border-bottom: 1px solid #000;"><th class="left">General Information</th></tr><tr style="height: 20px;" /><tr><th class="left">Zip Code</th class="placeholder"><th></th><th></th><th></th><th class="right">{zipcode}</th></tr><tr><th class="left">City</th><th class="placeholder"></th><th></th><th></th><th class="right">{city}</th></tr><tr><th class="left">District</th><th class="placeholder"></th><th></th><th></th><th class="right">{district}</th></tr><tr><th class="left">Federal State</th><th class="placeholder"></th><th></th><th></th><th class="right">{federal_state}</th></tr><tr><th class="left">Radius of analysis</th><th class="placeholder"></th><th></th><th></th><th class="right">{time} minutes of {movement}</th></tr><tr style="height: 30px;" />'
    response += f'<tr style="border-bottom: 1px solid #000;"><th class="left">Demographic trend</th></tr><tr style="height: 5px;" /><tr><th class="left">{countie[0]}, LK</th><th></th><th class="right">2019 Actual</th><th class="right">2030 Forecast</th><th class="center">Change in %</th></tr><tr><td class="left">Population</td><td></td><td class="right">{data[0][19]}</td></tr><tr><td class="left">Population 65-74</td><td></td><td class="right">{peopleu75}</td><td class="right">999999</td><td class="center">999%</td></tr><tr><td class="left">Population 75+</td><td></td><td class="right">{peopleo75}</td><td class="right">999999</td><td class="center">999%</td></tr><tr><td class="left">Patients receiving full inpatient care</td><td></td><td class="right">{sum}</td><td class="right">999999</td><td class="center">999%</td></tr><tr style="height: 30px;" />'
    response += f'<tr style="border-bottom: 1px solid #000;"><th class="left">Demand</th><th></th><td class="right">Radius:</td><td class="left"> {time} minutes of {movement}</td></tr><tr><td class="left">Number of inpatients</td><td></td><td class="right">{inpatients}</td></tr><tr><td class="left">Number of inpatients forecast 2030</td><td></td><td></td><td class="right">999999</td></tr><tr style="height: 30px;" />'
    response += f'<tr style="border-bottom: 1px solid #000;"><th class="left">Supply</th><th></th><td class="right">Radius:</td><td class="left"> {time} minutes of {movement}</td></tr><tr><td class="left">Beds</td><td></td><td class="right">{beds_active}</td></tr><tr><td class="left">Nursing homes</td><td></td><td class="right">{nursingHomes_active}</td></tr><tr><td class="left">Nursing homes in planning</td><td></td><td class="right">{nursingHomes_planned}</td></tr><tr><td class="left">Nursing homes under construction</td><td></td><td class="right">{nursingHomes_construct}</td></tr><tr><td class="left">Beds in planning</td><td></td><td class="right">{beds_planned}</td></tr><tr><td class="left">Beds under construction</td><td></td><td class="right">{beds_construct}</td></tr><tr><td class="left">Adjusted number of beds (incl. beds</td><td></td></tr><tr><td class="left">in planning and under construction</td><td></td><td class="right">{beds_adjusted}</td></tr><tr><td class="left">Occupancy rate</td><td></td><td class="right">{occupancy_raw}%</td></tr><tr><td class="left">Median Invest Cost</td><td></td><td class="right">{investMedian} €</td></tr><tr style="height: 5px;" /><tr style="border-bottom: 1px solid #000;"><th class="left">Surplus or deficit 2030 of beds IC</th><th></th><th></th><th class="right">999999</th></tr><tr style="height: 30px;" />'
    response += f'<tr style="border-bottom: 1px solid #000;"><th class="left">Market shares</th><th></th><td class="right">Radius:</td><td class="left"> {time} minutes of {movement}</td></tr><tr style="height: 15px;" /><tr><td class="left">Number of operators</td><td></td><td class="right">{len(operator)}</td></tr><tr><td class="left">Median Number of beds</td><td></td><td class="right">{bedsMedian}</td></tr><tr><td class="left">Median Year of construction</td><td></td><td class="right">{yearMedian}</td></tr><tr><td class="left">% Public operators</td><td></td><td class="right">{op_public_percent}%</td></tr><tr><td class="left">% Non-profit operators</td><td></td><td class="right">{op_nonProfit_percent}%</td></tr><tr><td class="left">% Private operators</td><td></td><td class="right">{op_private_percent}%</td></tr>'
    response += '</table>'
    response += '</td><td class="placeholder"></td><td>'
