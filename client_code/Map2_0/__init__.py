  ...
  #####   Extra Functions   #####
    ...
    def popup(self, click):
      ...
      #Check which Layer is active
        ...
        popup_text = f'<button type="button" onClick="hide_mun_info()">&#10006;</button><br><br><h3>Municipality: {gm_name}</h3><b>ID:</b> {key}<br><b>Area:</b> {data[0][9]} km&sup2;<br><br><b>Population</b><br><br><b>Overall:</b><br><table><tr><th>Overall</th><th>Under 3</th><th>3 to Under 6</th><th>6 to Under 10</th><th>10 to Under 15</th><th>15 to Under 18</th><th>18 to Under 20</th><th>20 to Under 25</th><th>25 to Under 30</th><th>30 to Under 35</th><th>35 to Under 40</th><th>40 to Under 45</th><th>45 to Under 50</th><th>50 to Under 55</th><th>55 to Under 60</th><th>60 to Under 65</th><th>65 to Under 75</th><th>75 and older</th></tr><tr><td>{data[0][10]}</td><td>{data[1][2]}</td><td>{data[1][3]}</td><td>{data[1][4]}</td><td>{data[1][5]}</td><td>{data[1][6]}</td><td>{data[1][7]}</td><td>{data[1][8]}</td><td>{data[1][9]}</td><td>{data[1][10]}</td><td>{data[1][11]}</td><td>{data[1][12]}</td><td>{data[1][13]}</td><td>{data[1][14]}</td><td>{data[1][15]}</td><td>{data[1][16]}</td><td>{data[1][17]}</td><td>{data[1][18]}</td></tr></table><br><b>Männlich:</b><br><table><tr><th>Overall</th><th>Under 3</th><th>3 to Under 6</th><th>6 to Under 10</th><th>10 to Under 15</th><th>15 to Under 18</th><th>18 to Under 20</th><th>20 to Under 25</th><th>25 to Under 30</th><th>30 to Under 35</th><th>35 to Under 40</th><th>40 to Under 45</th><th>45 to Under 50</th><th>50 to Under 55</th><th>55 to Under 60</th><th>60 to Under 65</th><th>65 to Under 75</th><th>75 and older</th></tr><tr><td>{data[1][37]}</td><td>{data[1][20]}</td><td>{data[1][21]}</td><td>{data[1][22]}</td><td>{data[1][23]}</td><td>{data[1][24]}</td><td>{data[1][25]}</td><td>{data[1][26]}</td><td>{data[1][27]}</td><td>{data[1][28]}</td><td>{data[1][29]}</td><td>{data[1][30]}</td><td>{data[1][31]}</td><td>{data[1][32]}</td><td>{data[1][33]}</td><td>{data[1][34]}</td><td>{data[1][35]}</td><td>{data[1][36]}</td></tr></table><br><b>Weiblich:</b><br><table><tr><th>Overall</th><th>Under 3</th><th>3 to Under 6</th><th>6 to Under 10</th><th>10 to Under 15</th><th>15 to Under 18</th><th>18 to Under 20</th><th>20 to Under 25</th><th>25 to Under 30</th><th>30 to Under 35</th><th>35 to Under 40</th><th>40 to Under 45</th><th>45 to Under 50</th><th>50 to Under 55</th><th>55 to Under 60</th><th>60 to Under 65</th><th>65 to Under 75</th><th>75 and older</th></tr><tr><td>{data[1][55]}</td><td>{data[1][38]}</td><td>{data[1][39]}</td><td>{data[1][40]}</td><td>{data[1][41]}</td><td>{data[1][42]}</td><td>{data[1][43]}</td><td>{data[1][44]}</td><td>{data[1][45]}</td><td>{data[1][46]}</td> <td>{data[1][47]}</td><td>{data[1][48]}</td><td>{data[1][49]}</td><td>{data[1][50]}</td><td>{data[1][51]}</td><td>{data[1][52]}</td><td>{data[1][53]}</td><td>{data[1][54]}</td></tr></table><br><b>per km&sup2:</b> {data[0][13]}<br><br><br><b>Grad der Verstädterung</b><br><br><b>Schlüssel:</b> {data[0][17]}<br><b>Bezeichnung:</b> {data[0][18]}'
